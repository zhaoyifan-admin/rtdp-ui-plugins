...
export default defineConfig({
  ...
  themeConfig: {
    ...
    editLink: {
      pattern: 'https://github.com/zhaoyifan-admin/rtdp-ui-plugins/tree/master/docs/:path',
      text: 'Suggest changes to this page'
    },
    // 默认支持icon包括：'discord'|'facebook'|'github'|'instagram'|'linkedin'|'mastodon'|'slack'|'twitter'|'youtube'
    socialLinks: [
      { icon: 'github', link: 'https://github.com/zhaoyifan-admin/rtdp-ui-plugins/rtdp-ui-plugins' }
      // 自定义icon
      // {
      //   icon: {
